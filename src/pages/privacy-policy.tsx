        ...
        <Segment basic padded style={{ margin: "1em", width: "90%" }}>
          <Container text>
            ...
            <p>
              ...
              that they shared and/or collect in Caption Manager. This policy is
            ...
            <h2>Log Files</h2>
            <p>
              Caption Manager follows a standard procedure of using log files.
            ...
            <p>
              ...
              the advertising partners of Caption Manager.
            </p>
            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Caption
              Manager, which are sent directly to users' browser. They
            ...
            <p>
              Note that Caption Manager has no access to or control over these
              cookies that are used by third-party advertisers.
            </p>
            <h2>Third Party Privacy Policies</h2>
            <p>
              Caption Manager's Privacy Policy does not apply to other
            ...
            <p>
              Caption Manager does not knowingly collect any Personal
